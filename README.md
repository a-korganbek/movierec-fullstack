...
# MovieRec Frontend — Angular

Frontend for MovieRec movie recommendation app.

## Tech Stack
Angular 17+, TypeScript, RxJS, HttpClient

## Features
- JWT authentication with auto token refresh via HTTP interceptors
- Browse and search movies
- Personal watchlist (add/remove, filter by status)
- Reactive async data flow with Observables
